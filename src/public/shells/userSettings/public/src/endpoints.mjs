/**
 * @file userSettings/public/src/endpoints.mjs
 * @description 用户设置 shell 的客户端 API 端点。
 * @namespace userSettings.public.endpoints
 */

/**
 * @function callApi
 * @memberof userSettings.public.endpoints
 * @description 调用 API。
