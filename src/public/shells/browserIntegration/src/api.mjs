...
/**
 * @description 管理单个用户通过用户脚本连接的所有浏览器页面。
 * 隔离页面、处理焦点跟踪和代理命令。
 */
class UserPageManager {
	...
	constructor(username) {
		...
		/**
		 * @description 此用户的所有页面（活动或最近断开连接）的列表。
		 * @type {PageInfo[]}
		 */
		this.pages = []
		/**
		 * @description 当前具有浏览器焦点的页面的ID。
		 * @type {number | undefined}
		 */
		this.focusedPageId = undefined
		/**
		 * @description 到Shell的UI的WebSocket连接集。
	...
	/**
	 * @description 向管理器添加一个新页面或恢复最近断开连接的页面。
	...
	/**
	 * @description 向特定页面发送命令并返回一个Promise，该Promise将以结果解析。
	...
	// --- Cleanup ---
	/**
	 * @description 从`pages`列表中删除旧的、断开连接的页面条目，以防止内存泄漏。
