/**
 * @file browserIntegration/public/src/endpoints.mjs
 * @description 浏览器集成 shell 的客户端 API 调用。
 * @namespace browserIntegration.public.endpoints
 */

/**
 * @function callApi
 * @memberof browserIntegration.public.endpoints
 * @description 对浏览器集成 shell 的后端 API 进行调用的通用函数。
...
/**
 * @function addAutoRunScript
 * @memberof browserIntegration.public.endpoints
 * @description 添加一个新的自动运行脚本。
...
/**
 * @function deleteAutoRunScript
 * @memberof browserIntegration.public.endpoints
 * @description 删除一个自动运行脚本。
