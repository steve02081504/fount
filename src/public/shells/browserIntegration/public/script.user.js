...
/**
 * @file browserIntegration/public/script.user.js
 * @description fount 浏览器集成用户脚本。允许 fount 角色与网页交互。
 * @namespace browserIntegration.userscript
 */
...
/**
 * @function gmFetch
 * @memberof browserIntegration.userscript
 * @description GM.xmlHttpRequest 的一个包装器，模仿 fetch() API。
...
function gmFetch(url, options = {}) {
	return new Promise((resolve, reject) => {
		GM.xmlHttpRequest({
			...
			onload: resolve,
			/**
			 * @description onerror 回调
			 */
			onerror: () => reject(new Error(`Request error for ${url}`)),
			/**
			 * @description ontimeout 回调
			 */
 ...
 * @memberof browserIntegration.userscript
 * @description 获取一个用于 JSON.stringify 的 replacer 函数，以处理循环引用。
 ...
 * @memberof browserIntegration.userscript
 * @description 从 fount 主机请求新的 API 密钥。
...
/**
 * @function checkCspAndWarn
 * @memberof browserIntegration.userscript
 * @description 检查 CSP 并发出警告。
 * @returns {Promise<void>}
 */
 ...
 * @memberof browserIntegration.userscript
 * @description 处理来自 WebSocket 的命令。
...
/**
 * @function loadUserLocalesFromFount
 * @memberof browserIntegration.userscript
 * @description 从 fount 加载用户区域设置。
 * @returns {Promise<void>}
 */
