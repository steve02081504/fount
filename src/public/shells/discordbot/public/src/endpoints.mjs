/**
 * @file discordbot/public/src/endpoints.mjs
 * @description Discord 机器人 shell 的客户端 API 端点。
 * @namespace discordbot.public.endpoints
 */
import { geti18n } from '../../../../scripts/i18n.mjs'

/**
 * @function fetchDataWithHandling
 * @memberof discordbot.public.endpoints
