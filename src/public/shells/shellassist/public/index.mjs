/**
 * @file shellassist/public/index.mjs
 * @description 终端助手 shell 的客户端逻辑。
 * @namespace shellassist.public
 */
...
/**
 * @function sendRemoteSocketMessage
 * @memberof shellassist.public
 * @description 发送远程套接字消息。
