...
/**
 * @file shellassist/src/terminal_ws.mjs
 * @description WebSocket 终端处理。
 * @namespace shellassist.terminal_ws
 */

/**
 * @function spawnShell
 * @memberof shellassist.terminal_ws
 * @description 生成一个 shell 进程。
