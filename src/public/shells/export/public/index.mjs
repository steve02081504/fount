/**
 * @file export/public/index.mjs
 * @description 导出 shell 的客户端逻辑。
 ...
 * @memberof export.public
 * @description 根据当前应用程序状态更新整个 UI。
 * 此函数集中了所有 UI 逻辑。
 */
function updateUIState() {
...
/**
 * @function onPartTypeSelected
 * @memberof export.public
 * @description 处理选择部件类型时的逻辑。
...
/**
 * @function fetchAndRenderPartTypes
 * @memberof export.public
 * @description 获取并渲染部件类型。
