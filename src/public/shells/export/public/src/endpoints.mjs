/**
 * @file export/public/src/endpoints.mjs
 * @description 导出 shell 的客户端 API 端点。
 * @namespace export.public.endpoints
 */

/**
 * @function getFountJson
 * @memberof export.public.endpoints
 * @description 获取部件的 fount.json 内容。
