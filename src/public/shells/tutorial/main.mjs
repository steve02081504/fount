export default {
	info: {
		'en-UK': {
			...
			description_markdown: 'Provides a step-by-step tutorial for new users to get acquainted with Project fount.',
			version: '0.0.1',
		...
		'zh-CN': {
			...
			description_markdown: '为新用户提供分步教程，以熟悉 Project fount。',
			version: '0.0.1',
			author: 'steve02081504',
			tags: ['教程', '指南', '帮助', '新用户']
		},
		'ar-SA': {
			...
			description_markdown: 'يوفر برنامجًا تعليميًا خطوة بخطوة للمستخدمين الجدد للتعرف على Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'de-DE': {
			...
			description_markdown: 'Bietet ein schrittweises Tutorial für neue Benutzer, um sich mit Project fount vertraut zu machen.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'es-ES': {
			...
			description_markdown: 'Proporciona un tutorial paso a paso para que los nuevos usuarios se familiaricen con Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'fr-FR': {
			...
			description_markdown: 'Fournit un tutoriel étape par étape pour que les nouveaux utilisateurs se familiarisent avec Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'is-IS': {
			...
			description_markdown: 'Býður upp á skref-fyrir-skref kennslu fyrir nýja notendur til að kynnast Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'it-IT': {
			...
			description_markdown: 'Fornisce un tutorial passo-passo per i nuovi utenti per familiarizzare con Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'ja-JP': {
			...
			description_markdown: '新規ユーザーがProject Fountに慣れるためのステップバイステップのチュートリアルを提供します。',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'ko-KR': {
			...
			description_markdown: '신규 사용자가 Project Fount에 익숙해질 수 있도록 단계별 튜토리얼을 제공합니다.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		lzh: {
			...
			description_markdown: '為新用戶提供分步儀軌，以熟悉 Project fount。',
			version: '0.0.1',
			author: 'steve02081504',
			tags: ['儀軌', '指南', '幫助', '新用戶']
		},
		'nl-NL': {
			...
			description_markdown: 'Biedt een stapsgewijze zelfstudie voor nieuwe gebruikers om vertrouwd te raken met Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'pt-PT': {
			...
			description_markdown: 'Fornece um tutorial passo a passo para que os novos usuários se familiarizem com o Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'ru-RU': {
			...
			description_markdown: 'Предоставляет пошаговое руководство для новых пользователей по ознакомлению с Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'uk-UA': {
			...
			description_markdown: 'Надає покроковий посібник для нових користувачів по ознайомленню з Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'vi-VN': {
			...
			description_markdown: 'Cung cấp hướng dẫn từng bước cho người dùng mới để làm quen với Project fount.',
			version: '0.0.1',
			author: 'steve02081504',
		...
		'zh-TW': {
			...
			avatar: 'https://api.iconify.design/line-md/backup-restore.svg',
			description: '一個引導用戶完成初始設置和基本功能的shell。',
			description_markdown: '為新用戶提供分步教程，以熟悉 Project fount。',
			version: '0.0.1',
			author: 'steve02081504',
			tags: ['教程', '指南', '幫助', '新用戶']
		}
