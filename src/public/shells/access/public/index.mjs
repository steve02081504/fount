/**
 * @file access/public/index.mjs
 * @description “访问”页面的客户端逻辑，用于生成和显示用于凭证传输的 URL 和二维码。
...
/**
 * @description IIFE（立即调用函数表达式）处理页面加载时的核心逻辑：
 ...
 * @memberof access.public
 * @description 使用给定的 URL 在指定的容器元素中生成并显示一个二维码。
