/**
 * @file chat/public/new/index.mjs
 * @description 创建新聊天的页面逻辑。
 * @namespace chat.public.new
 */
...
/**
 * @function main
 * @memberof chat.public.new
 * @description 初始化页面，创建一个新的聊天会话，根据 URL 参数添加一个角色（如果提供），然后重定向到主聊天页面。
