/**
 * 通用 Promise 去重与 LRU Map（浏览器 / Deno 共用）。
 */
 ...
 * @returns {((rawKey: string) => Promise<T>) & { deleteKey: (rawKey: string) => void, deleteMatching: (predicate: (key: string) => boolean) => void }} 去重后的加载函数
 */
