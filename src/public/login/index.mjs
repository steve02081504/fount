...
import { pingServer, generateVerificationCode, submitAuthForm } from '../scripts/endpoints.mjs'
...
const isLocalOrigin = await pingServer()
...
async function handleFormSubmit(event) {
	...
	try {
		const response = await submitAuthForm(isLoginForm, username, password, deviceid, verificationcode)
