...
/** @typedef {import('../../../../../decl/stickerAPI.ts').StickerPack} StickerPack */
/** @typedef {import('../../../../../decl/stickerAPI.ts').Sticker} Sticker */
/** @typedef {import('../../../../../decl/stickerAPI.ts').UserStickerCollection} UserStickerCollection */
 ...
 * 获取用户贴纸收藏
 * @param {string} username - 用户名
 * @returns {Promise<UserStickerCollection>}
 */
