...
- **UI**: no explanatory `data-i18n` on invisible controls; omit unavailable context-menu items. Bootstrap: `public/index.mjs`; state `cabinetStore`; DOM under `public/src/`; Deno-pure helpers under `public/shared/` (`keyboard`, `commandHistory`).
