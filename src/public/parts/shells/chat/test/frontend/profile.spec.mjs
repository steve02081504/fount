...
test.describe('Chat profile page', () => {
	...
	test('profile edit opens modal', async ({ page, baseUrl }) => {
		...
		await page.locator('.hub-profile-locale-add-input').fill('x-copy-test')
		await page.locator('.hub-profile-locale-add-input').press('Enter')
		...
		await page.locator('.hub-profile-locale-tab[data-locale="x-copy-test"]').click()
		await page.locator('.hub-profile-locale-tab-edit').fill('x-renamed-test')
		await page.locator('.hub-profile-locale-tab-edit').press('Enter')
