...
$setup = Setup-OpenGroupJoin 'FedEmoji' 'emoji-seed'
$gid = $setup.groupId

Write-Host "`n=== 1. A uploads group emoji ===" -ForegroundColor Cyan
T 'A POST /groups/:id/emojis multipart' {
...
T 'B data matches A (same length)' {
