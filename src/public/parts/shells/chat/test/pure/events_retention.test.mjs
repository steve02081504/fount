 ...
 * 复测：deno test --no-check --allow-all src/public/parts/shells/chat/test/events_retention.test.mjs
 */
/* global Deno */
import { assertEquals } from 'https://deno.land/std@0.224.0/assert/mod.ts'

import { PERMISSION_ANCHOR_TYPES } from '../../../../../../scripts/p2p/retention_policy.mjs'
import { computeRetentionKeepIds } from '../../src/chat/events/retention.mjs'
