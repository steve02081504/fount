 ...
 * 【职责】chat 会话子系统进程级初始化与联邦 Char/World/Persona RPC 分发。
...
import { createCharRpcDispatcher, createPersonaRpcDispatcher, createWorldRpcDispatcher } from './federation/rpcDispatcher.mjs'
...
/**
 * 在本地群运行时尝试分发 Persona RPC（供联邦 `char_rpc` 入站回调）。
 */
export const tryInvokeLocalPersonaRpc = createPersonaRpcDispatcher(getChatRequest)
