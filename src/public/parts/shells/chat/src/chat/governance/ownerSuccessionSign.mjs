 ...
 * 【职责】本机管理员为 owner_succession_ballot DAG 事件生成 Ed25519 选票签名，供继任流程验签。
 * 【原理】signOwnerSuccessionAsLocalAdmin 用 dag/localSigner 种子密钥对 ballot 字节签名；验签域在 scripts/p2p/owner_succession_ballot.mjs。
 * 【数据结构】ballot { proposedOwnerPubKeyHash, groupId, ballotId }→{ pubKeyHex, signature }。
 * 【关联】dag/append 治理事件、localSigner.mjs、materialize 群主迁移逻辑。
 */
/**
 * 【文件】governance/ownerSuccessionSign.mjs
