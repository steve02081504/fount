 ...
 * 【原理】原始条目全部保留；仅从最新往旧扫描第一个可见的 `type==='summary'` 条目，返回其起（含）的切片。
 * 【关联】session/summarize.mjs 生成 summary 条目；prompt_struct/index.mjs 调用。
 */
 ...
 * @returns {boolean} 是否为 `type === 'summary'`
 */
