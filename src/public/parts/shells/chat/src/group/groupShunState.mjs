 ...
 * @returns {{ shunsByNode: Record<string, number>, suspectedRemoved: boolean, suspectedAt: number | null, shunnedBy: string[], bannerDismissed: boolean, lastProbeAt: number, knownPeerCount: number }} 规范化状态
 */
