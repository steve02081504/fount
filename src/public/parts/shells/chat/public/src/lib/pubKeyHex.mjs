/**
 * 【文件】public/src/lib/pubKeyHex.mjs
 * 【职责】64 位小写 hex 标识校验：公钥哈希、DAG eventId、签名 hex。
 * 【原理】HEX_ID_64、PUB_KEY_HEX_64、EVENT_ID_HEX 正则；normalizeHex64/isHex64/isSignatureHex128 工具。
 * 【数据结构】hex 字符串、布尔校验结果。
 * 【关联】全 api 与 DAG 相关模块；dmLink、streaming。
 */
