/**
 * 【文件】public/src/endpoints/groupFederation.mjs
...
/**
 * 驳回「疑似被移出」横幅（保留历史，不退群）。
 * @param {string} groupId 群 ID
 * @returns {Promise<void>}
 */
export async function dismissShunBanner(groupId) {
	await groupFetch(groupPath(groupId, 'federation', 'shun-dismiss'), { method: 'POST', json: {} })
}
