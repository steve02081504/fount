...
export function getChatGestures() {
	if (!chatGestures)
		chatGestures = createChatGestures({
			...
			getGroupId: () => hubStore.context.currentGroupId || hubStore.privateGroup.groupId,
			/** @returns {string|null} 当前频道 ID */
			getChannelId: () => hubStore.context.currentChannelId || hubStore.privateGroup.channelId,
