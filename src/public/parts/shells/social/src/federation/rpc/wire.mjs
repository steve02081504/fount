...
} from 'npm:@steve02081504/fount-p2p/wire/part/fanout'
 ...
 * @returns {Promise<import('npm:@steve02081504/fount-p2p/wire/part/invoke').PartInvokeResponse[]>} 邻居 PartInvokeResponse
 */
