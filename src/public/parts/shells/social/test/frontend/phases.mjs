...
export const phases = [
	...
	{
		name: 'actions',
		testMatch: ['postActions.spec.mjs', 'replies.spec.mjs', 'postDetail.spec.mjs', 'fount_user_send.spec.mjs'],
	},
	{
	...
	{
		name: 'core',
		testMatch: ['deepLink.spec.mjs', 'feed.spec.mjs', 'navigation.spec.mjs', 'profile.spec.mjs', 'saved.spec.mjs', 'drafts.spec.mjs', 'videos.spec.mjs', 'xssInjection.spec.mjs'],
	},
	{
		name: 'tail',
