/**
 * Batch 11：feed 归并 / engagement / feedHub 推送。
 * 复测：deno test --no-check --allow-all src/public/parts/shells/social/test/batch11_feed_merge_ws.test.mjs
 */
/* global Deno */
...
const feedHelpers = await import('../src/feedHelpers.mjs')
