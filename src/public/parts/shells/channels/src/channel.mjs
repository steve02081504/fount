...
/** @typedef {import('../../../../../decl/channelAPI.ts').ChannelConfig} ChannelConfig */
/** @typedef {import('../../../../../decl/channelAPI.ts').ChannelMessage} ChannelMessage */
/** @typedef {import('../../../../../decl/channelAPI.ts').ChannelMember} ChannelMember */
/** @typedef {import('../../../../../decl/channelAPI.ts').ChannelRole} ChannelRole */
/** @typedef {import('../../../../../decl/channelAPI.ts').ChannelPermission} ChannelPermission */
 ...
 * @param {string} username - 用户名
 * @param {string} channelId - 频道ID
 * @returns {Promise<ChannelRole | null>}
 */
