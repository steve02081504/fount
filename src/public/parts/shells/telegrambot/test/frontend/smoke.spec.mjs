/**
 * Telegram bot shell 前端 smoke：页面可加载、核心控件可见。
 */
import { test, expect } from './fixtures.mjs'

test.describe('Telegram bot shell smoke', () => {
	test('config page loads with bot controls', async ({ page, baseUrl }) => {
		await page.goto(`${baseUrl}/parts/shells:telegrambot/`, { waitUntil: 'domcontentloaded' })
