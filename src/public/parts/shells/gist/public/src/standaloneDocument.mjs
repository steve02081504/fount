...
function renderAttachmentsHtml(files, downloadLabel) {
	...
	for (const file of files || []) {
		...
		items.push(`
			<div class="attachment" style="border: var(--border) solid var(--color-base-300); border-radius: var(--radius-field); padding: 10px; margin: 5px; display: inline-block; text-align: center; max-width: 200px;">
...
export function wrapStandaloneMarkdownDocument(messageHtml, options = {}) {
	...
	const attachmentsHtml = renderAttachmentsHtml(
		options.files,
...
` : ''}	</${'script'}>
	...
	<footer class="w-full text-center text-xs text-gray-500 p-4">
		<p>Generated by <a class="link" href="${hasCodeBlock ? 'https://github.com/steve02081504/fount' : 'https://steve02081504.github.io/fount'}" target="_blank">fount</a></p>
	</footer>
</body>
