import { getDiscordClientForChar } from '../../shells/discordbot/src/default_interface.mjs'
...
不在 Discord 桥接触发上下文中时，message、channel 和 guild 不可用；平台原生对象请使用 bridgeOps.getNativeContext。
