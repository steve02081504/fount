...
import { buildSamplingReplayOptions, collectLocalLogprobs, createStreamingLogprobsCollector } from './src/localLogprobs.mjs'
...
async function GetSource(config) {
	...
	const result = {
		...
		StructCall: async (/** @type {prompt_struct_t} */ prompt_struct, options = {}) => {
			...
			/** @type {import('npm:node-llama-cpp@3.18.1').Token[]} */
			const streamTokens = []
