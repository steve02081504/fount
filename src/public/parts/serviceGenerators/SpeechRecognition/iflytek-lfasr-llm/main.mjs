...
import { formatUtcPlus8, hmacSha1Base64 } from '../shared/iflytekAuth.mjs'
...
async function GetSource(config) {
	...
	return {
		...
		info: buildSourceInfo(product_info, { name: config.name || 'iFlytek LFASR LLM', provider: 'iflytek' }),
		is_paid: true,
		extension: {},
		/**
