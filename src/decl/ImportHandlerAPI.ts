 ...
 * @description 定义了导入处理器的 API 结构，用于处理角色数据的导入和管理。
 */
export class importHandlerAPI_t {
	/**
	 * @description 导入处理器的详细信息。
	 */
	info: info_t
	/**
	 * @description 在安装角色时调用，如果失败，将删除该角色文件夹下的所有文件。
	...
	/**
	 * @description 导入处理器支持的接口。
	 */
	interfaces: {
		/**
		 * @description 信息接口，用于更新导入处理器的信息。
		 */
		info?: {
			/**
			 * @description 更新导入处理器的本地化信息。
		...
		/**
		 * @description 导入接口，用于导入角色数据。
		 */
		import: {
			/**
			 * @description 将二进制数据作为角色数据导入。
