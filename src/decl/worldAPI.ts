import { channelMessage_t, chatReply_t, chatReplyRequest_t, type chatViewer_t } from '../public/parts/shells/chat/decl/chatLog.ts'
...
export type WorldChatHost_t = {
	...
	postSystemMessage(channelId: string, content: channelMessage_t): Promise<void>
