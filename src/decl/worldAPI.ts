...
/**
 * @class WorldAPI_t
 * @description 定义了世界 API 的结构。
 */
export class WorldAPI_t {
	/**
	 * @description 世界 API 的详细信息。
	 */
	info: info_t
	/**
	...
	/**
	 * @description 世界 API 支持的接口。
	 */
	interfaces?: {
		/**
		 * @description 信息接口，用于更新世界 API 的信息。
		 */
		info?: {
			/**
			 * @description 更新世界 API 的本地化信息。
