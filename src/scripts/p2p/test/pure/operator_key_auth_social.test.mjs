...
import { activeSenderHashFromPubKeyHex } from '../../operator_key_chain.mjs'
import {
	foldOperatorKeyHistoryFromEvents,
	isOperatorTimelineWriteAuthorized,
} from '../../../../public/parts/shells/social/src/federation/operator_key_auth.mjs'

Deno.test('social foldOperatorKeyHistoryFromEvents tracks social_meta and rotate', () => {
