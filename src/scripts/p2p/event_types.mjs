...
export const EVENT_TYPE_DEFS = {
	member_join: { aclGated: true, gcExclude: true, governance: true },
	member_leave: { aclGated: true, gcExclude: true, governance: true },
	member_kick: { aclGated: true, gcExclude: true, governance: true },
	member_ban: { aclGated: true, gcExclude: true, governance: true },
	member_unban: { aclGated: true, gcExclude: true, governance: true },
	role_create: { aclGated: true, gcExclude: true, governance: true },
	role_update: { aclGated: true, gcExclude: true, governance: true },
	role_delete: { aclGated: true, gcExclude: true, governance: true },
	role_assign: { aclGated: true, gcExclude: true, governance: true },
	role_revoke: { aclGated: true, gcExclude: true, governance: true },
	...
	channel_key_rotate_batch: { aclGated: true, gcExclude: true, governance: true },
	...
	reputation_reset: { aclGated: true, gcExclude: true, governance: true },
	key_rotate: { aclGated: true, gcExclude: true, governance: true },
	peer_invite: { aclGated: true, gcExclude: true, governance: true },
	dag_tip_merge: { aclGated: true, governance: true },
	list_item_update: { aclGated: true },
	file_upload: { aclGated: true },
	file_delete: { aclGated: true },
	file_system_update: { aclGated: true },
...
function typesWithFlag(flag) {
	return new Set(Object.entries(EVENT_TYPE_DEFS).filter(([, f]) => f[flag]).map(([k]) => k))
}
...
export const SESSION_EVENT_TYPES = new Set(
	Object.keys(EVENT_TYPE_DEFS).filter(type => type.startsWith('session_')),
)
