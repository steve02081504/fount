 ...
 *   transportReachRate: number,
 *   signalingDiversityRate: number,
 *   joinThrottleEffectiveness: number,
...
export const RATE_METRIC_KEYS = Object.freeze([
	...
	'transportReachRate',
	'signalingDiversityRate',
	'joinThrottleEffectiveness',
