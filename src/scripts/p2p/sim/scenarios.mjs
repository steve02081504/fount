...
export const SCENARIOS = [
	{
		...
		attacks: {
			sybil: 4, collusion: 3, spammer: 2, false_accuser: 2, eclipse: 2,
			lazy_chunk: 2, social_mob: 2, archive_forger: 2, relay_farmer: 2,
		},
		rounds: 40,
		groupSize: 8,
	},
	{
		...
		honestCount: 8,
		relayCount: 2,
		attacks: { sybil: 16, eclipse: 4, relay_farmer: 4 },
		rounds: 50,
		groupSize: 6,
	},
	{
		...
		honestCount: 10,
		relayCount: 1,
		attacks: { collusion: 10, whitewasher: 3 },
		rounds: 45,
		groupSize: 10,
	},
	{
	...
	},
	{
		...
		attacks: { social_mob: 3, lazy_chunk: 3, archive_forger: 2, false_accuser: 2 },
		rounds: 40,
		groupSize: 8,
	},
]
