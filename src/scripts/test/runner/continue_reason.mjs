...
/**
 * @typedef {'missing_state_record' | 'imperfect_failed' | 'imperfect_noisy' | 'imperfect_blocked' | 'stale_content' | 'diff_trigger_hit' | 'diff_dependent' | 'explicit_selected' | 'failure_retry' | 'dependency_required'} GoalEvidenceKind
 */
