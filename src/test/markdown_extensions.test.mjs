...
import socialMarkdownExt from '../public/parts/shells/social/public/markdown_ext/index.mjs'
...
Deno.test('social markdown extension exports remark plugins', () => {
	assertEquals(Array.isArray(socialMarkdownExt.remarkPlugins), true)
	assertEquals(socialMarkdownExt.remarkPlugins.length >= 1, true)
})
