...
- **Unconstrained AI Source Integration: Embrace the Infinite**
  fount offers unparalleled _choice_ and _flexibility_ in connecting AI sources. Custom JavaScript code in the AI Source Generator allows you to connect to _any_ AI source – OpenAI, Claude, [Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=fount), OpenRouter, NovelAI, Horde, Ooba, Tabby, Mistral... In the flow of code, you can carefully design complex regular expressions, call extensive API libraries, and embed multimedia resources. fount also natively supports the creation of API Pools to achieve intelligent request routing. The logic of communication follows _your_ will, shaped by the power of code.
