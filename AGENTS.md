...
- **Lint**: `eslint --fix --quiet` (no `npx`).
- **IDs / case**: `normalizeHex64` only for verify domains, deterministic protocol IDs, and untrusted inbound auth. Inverted-index posting-key exception: [search/AGENTS.md](src/scripts/search/AGENTS.md).
