...
* **Интеграция с Discord/Telegram:** Подключайте персонажей к своим сообществам Discord/Telegram через встроенные Bot Shells.
...
* **Непрерывная интеграция (fount-charCI):** Используйте [fount-charCI](https://github.com/marketplace/actions/fount-charci) для защиты разработки ваших персонажей. Он автоматически запускает тесты асинхронно при каждом коммите и сообщает о проблемах в реальном времени.
...
Более простое объяснение: Просто добавьте `https://steve02081504.github.io/fount/protocol?url=fount://run/shells/install/install;` перед ZIP-ссылкой вашего компонента/ссылкой на Git-репозиторий!
