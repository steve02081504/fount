...
- **تكامل مصادر الذكاء الاصطناعي بلا قيود: احتضان اللانهاية**
  يوفر fount _مرونة_ و_اختيارًا_ لا مثيل لهما في الاتصال بمصادر الذكاء الاصطناعي. تسمح لك التعليمات البرمجية المخصصة بلغة JavaScript في مولد مصادر الذكاء الاصطناعي بالاتصال _بأي_ مصدر ذكاء اصطناعي - OpenAI، Claude، [Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=fount)، OpenRouter، NovelAI، Horde، Ooba، Tabby، Mistral... في تدفق التعليمات البرمجية، يمكنك تصميم تعبيرات عادية معقدة بعناية، واستدعاء مكتبات API ضخمة، وتضمين موارد الوسائط المتعددة. يدعم fount أيضًا بشكل أصلي إنشاء مجمعات API لتحقيق توجيه ذكي للطلبات. منطق الاتصال، يتبع _رغبتك_، ويتشكل بقوة التعليمات البرمجية.
