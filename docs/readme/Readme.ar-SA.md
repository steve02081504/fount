<details>
<summary><small>ملخص سريع</small></summary>

fount منصة تشغيل وكلاء قابلة للبرمجة ومعيارية ووحدوية وقابلة للتخصيص، تحمّل مكونات مختلفة لتقديم الخدمات.  
للمسائل المتعلقة بالكود، راجع [deepwiki](https://deepwiki.com/steve02081504/fount).  
<small>اسم fount بأحرف صغيرة فقط—هو `f`ount وليس `F`ount.</small>

#### لماذا fount؟

- نظام بيئي معياري وغني وقوي جاهز للاستخدام؛ تجنب إعادة اختراع العجلة وكوابيس التصحيح
- خصّص منطق الوكيل، وليس فقط المحفزات والواجهة
- استخدم وتعلم من وكلاء fount الأقوى الآخرين في المجتمع
- مناسب للمكتب، تصدير تقارير سريع
- دمج سلس للشخصيات في IDE والمتصفحات والمحطات وTelegram وغيرها
- إضافات موجهة للوكلاء من المجتمع لا تملكها واجهات الدردشة LLM الأخرى
- اضبط الـ API ثم استخدم الشخصية الافتراضية ZL-31 لإكمال إعداد المكونات والإنشاء وجميع عمليات المستخدم عبر المحادثة—بدون تعلم أو إدماج
- تحدث بحرية مع مستخدمي fount الآخرين ووكلائهم (Agents)، وشارك ملفات بلا حد للحجم، وتفاعل بالإعجابات، واستخدم رموزًا تعبيرية مخصصة. بلا رقابة، بلا خطر حظر، وبلا اشتراكات باهظة

#### لماذا لا fount؟

- منحنى تعلم أكثر انحداراً، معرفة بالكود مطلوبة
- قد تحتوي بعض مكونات المجتمع على كود ضار؛ احكم واختر بعناية

##### ماذا أستخدم؟

استخدم [OpenClaw](https://openclaw.ai/) عندما:

- تريد تجربة وكلاء الذكاء الاصطناعي دون تخصيص عميق أو ضبط كفاءة

استخدم [ChatGPT](https://chatgpt.com/) أو منصات دردشة LLM عبر الإنترنت المماثلة عندما:

- تريد فقط الدردشة
- لا تحتاج تخصيصاً عميقاً لشخصيات الذكاء الاصطناعي
- لا تمانع تخزين سجل الدردشة في السحابة دون تصدير أو ترحيل
- لا تمانع الإعلانات

استخدم [character.ai](https://character.ai/) أو منصات لعب أدوار شخصيات LLM عبر الإنترنت المماثلة عندما:

- تريد تشغيل شخصية مدعومة بـ LLM دون ميزات الوكيل
- تقبل تكاليف الاشتراك
- لا تريد إعداد البرنامج

استخدم [Discord](https://discord.com/) عندما:

- تريد الدردشة ولا تهتم باحتمال الحظر
- تقبل حدود حجم رفع الملفات والإعلانات

استخدم [SillyTavern](https://github.com/SillyTavern/SillyTavern/) عندما:

- تحتاج شخصية أو ميزة تتطلب STscript أو إضافات SillyTavern

استخدم [SSP](https://ssp.shillest.net/) عندما:

- تريد تشغيل حيوانات أليفة سطح المكتب المتنوعة ولا تحتاج بالضرورة إلى استخدامها للذكاء الاصطناعي
...
fount هو **بيئة تشغيل حديثة وقابلة للتوسع لوكلاء الذكاء الاصطناعي (AI Agent)**.
...
## 🚀 الكفاءة والهندسة: مصمم للمحترفين والمطورين وهواة التقنية

يحوّل fount التفاعل إلى أصول إنتاجية، حيث كل شيء قابل للسحب والإفلات، وكل شيء هو ملف، والمنطق مدفوع بالتعليمات البرمجية.

### 1. لا حاجة للتعلم، جاهز للاستخدام

- اضبط الـ API ثم استخدم الشخصية الافتراضية ZL-31 لإكمال إعداد المكونات والإنشاء و**جميع عمليات المستخدم** عبر المحادثة—بدون تعلم أو إدماج.
  ![صورة](https://github.com/user-attachments/assets/b871ec43-731a-468c-ad74-6c5a7ba8d737)

### 2. تحويل المعرفة إلى أصول ومشاركة سلسة
...
- **تغليف وتوزيع سير العمل**: اسحب الشخصية التي أنشأتها مباشرة إلى سطح المكتب لإنشاء ملف قابل للمشاركة. اجعل هندسة الموجّهات ومنطق سير عملك قابلة للتوزيع بسهولة على الزملاء أو المجتمع.
  ![صورة](https://github.com/user-attachments/assets/5e14fe6e-2c65-492a-a09f-964c1e8ab9e0)

### 3. بيئة تنفيذ التعليمات البرمجية في الوقت الفعلي

لم يعد الأمر مجرد تمييز لـ Markdown. في fount، كتل التعليمات البرمجية المرسلة من قبل الشخصية هي **حيوية**.
...
### 4. تعاون P2P على الشبكة المحلية: كسر العزلة وحماية الخصوصية

fount ليس فقط رفيقك الرقمي الشخصي، بل أيضًا محطة فريقك الخاصة. يدعم أصلًا اتصال P2P مشفرًا. دون إعداد معقد، يكفي رابط دعوة بسيط لربط الزملاء على نفس الشبكة المحلية.

أنت وزملاؤك ووكلاؤكم (Agents) يمكنكم الاجتماع في فضاء رقمي خالص لمناقشة الكود ونقل الملفات الضخمة. بلا خوادم خارجية متطفلة، بلا حدود عرض نطاق عام — كل شرارات الحوار والبيانات السرية تتدفق بأمان داخل شبكتكم الداخلية.

حتى بلا موجه شبكة، يمكنكم الاتصال مباشرة عبر Bluetooth. للمطورين المحترفين، يسمح fount بتخصيص وتوسيع طبقة P2P لدعم LoRa وNFC والأشعة تحت الحمراء وUSB وحتى بروتوكولات تبادل مخصصة مثل الموجات الصوتية.

![صورة](https://github.com/user-attachments/assets/be1bbb97-242c-4b9b-8b4d-c9bf94c125c1)
...
- **تكامل VSCode**: هيكل المشروع واضح، وبالاقتران مع التوجيهات المقدمة في [AGENTS.md](../../AGENTS.md)، يمكنك تطوير وتصحيح منطق الوكيل الخاص بك مباشرة في بيئة التطوير المتكاملة (IDE) المفضلة لديك.
...
- **دردشة معبرة وغامرة**
  يسمح fount، بفضل قوة HTML، للشخصية بالتعبير عن نفسه من خلال النصوص الغنية، الصور، وحتى العناصر التفاعلية، مما يجعل كل محادثة حية وعميقة.

- **ملتقى الأفكار: الدردشة الجماعية الأصلية**
  ادعُ عدة شخصيات للانضمام إلى نفس المحادثة، وشاهد تفاعلاتهن الديناميكية والجذابة، سواء كانت عصفًا ذهنيًا في العمل، أو تمثيلًا للقصص بين الشخصيات.
  ![صورة](https://github.com/user-attachments/assets/eea1cc7c-d258-4a2d-b16f-12815a88811d)

- **واجهة جميلة وقابلة للتخصيص**
  اختر من بين أكثر من 30 سمة مذهلة، أو اصنع ألوانك الخاصة بنفسك. fount هي لوحتك الفنية الخاصة.
  ![صورة](https://github.com/user-attachments/assets/0d327a06-6446-4bf3-8a05-f941aa5f4ed9)
...
- **تكامل مصادر الذكاء الاصطناعي بلا قيود: احتضان اللانهاية**
  يوفر fount _مرونة_ و*اختيارًا* لا مثيل لهما في الاتصال بمصادر الذكاء الاصطناعي. تسمح لك التعليمات البرمجية المخصصة بلغة JavaScript في مولد مصادر الذكاء الاصطناعي بالاتصال _بأي_ مصدر ذكاء اصطناعي - OpenAI، Claude، [Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=fount)، [Evolink](https://evolink.ai/?utm_source=github&utm_medium=link&utm_campaign=fount)، OpenRouter، NovelAI، Horde، Ooba، Tabby، Mistral... في تدفق التعليمات البرمجية، يمكنك تصميم تعبيرات عادية معقدة بعناية، واستدعاء مكتبات API ضخمة، وتضمين موارد الوسائط المتعددة. يدعم fount أيضًا بشكل أصلي إنشاء مجمعات API لتحقيق توجيه ذكي للطلبات. منطق الاتصال، يتبع _رغبتك_، ويتشكل بقوة التعليمات البرمجية.
...
إذا كنت ترغب في التوقف للحظة، لترتيب أفكارك قبل المغامرة الكبرى (تشغيل تجريبي):
...
## هل واجهت بعض العقبات؟ لا داعي للقلق
...
- **Mozilla Firefox**: إنه مثل رحالة عنيد، يتبنى التقنيات الجديدة دائمًا ببطء، وأحيانًا يختار التوقف في الماضي إلى الأبد. هذا الإصرار قد يؤدي إلى بعض الأسف:
  - بسبب نقص الدعم لـ [`speculationrules`](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/script/type/speculationrules)، سيكون كل بدء تشغيل بارد ومعالجة بروتوكول في fount أبطأ بمقدار 1-2 ثانية مما ينبغي، هذه لحظات مسروقة بهدوء.
...
- **Apple Safari**: قد يكون دعمه لمعايير الويب "الناشئة" (منذ عدة سنوات) أقرب قليلاً من Firefox، لكنه في النها لك ليس أكثر بكثير.
  - يعني نقص الدعم لـ [`speculationrules`](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/script/type/speculationrules) أيضًا أن بدء التشغيل البارد لـ fount سيظل بطيئًا بعض الشيء، مما يهدر لحظاتك الثمينة.
