...
- **Giao diện Đẹp, Có thể Tùy chỉnh**
  ...
  ![Hình ảnh](https://github.com/user-attachments/assets/0d327a06-6446-4bf3-8a05-f941aa5f4ed9)
...
- **Tích hợp Nguồn AI Không Ràng buộc: Ôm lấy Vô hạn**
  fount cung cấp _sự lựa chọn_ và _tính linh hoạt_ không gì sánh được trong việc kết nối các nguồn AI. Mã JavaScript tùy chỉnh trong Trình tạo Nguồn AI cho phép bạn kết nối với _bất kỳ_ nguồn AI nào – OpenAI, Claude, [Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=fount), [Evolink](https://evolink.ai/?utm_source=github&utm_medium=link&utm_campaign=fount), OpenRouter, NovelAI, Horde, Ooba, Tabby, Mistral... Trong luồng mã, bạn có thể thiết kế cẩn thận các biểu thức chính quy phức tạp, gọi các thư viện API mở rộng và nhúng tài nguyên đa phương tiện. fount cũng hỗ trợ gốc việc tạo API Pools để đạt được định tuyến yêu cầu thông minh. Logic giao tiếp tuân theo _ý muốn của bạn_, được định hình bởi sức mạnh của mã.
  ![Hình ảnh](https://github.com/user-attachments/assets/f283d1de-c531-4b7a-bf43-3cbe0c48b7b9)

Nếu bạn cảm thấy lạc lối trong biển vai trò, hoặc đang tìm kiếm những câu chuyện bị lãng quên, [**cộng đồng sôi nổi và thân thiện của chúng tôi**](https://t.me/GentianAphrodite) đang chờ đón bạn. Đó là nơi trú ẩn cho những người cùng chí hướng, nơi các nhà phát triển và người sáng tạo chia sẻ sự thông thái và những sáng tạo của họ.
...
- **Tích hợp Telegram/Discord**
  Kết nối các nhân vật của bạn với các cộng đồng Telegram hoặc Discord thông qua các Bot Shells tích hợp, biến họ thành những thành viên sống động trong vòng kết nối của bạn.
...
## Sáng tạo: Vượt ra ngoài những giới hạn của lời nhắc
...
- **Cộng đồng Telegram:** Tham gia [cộng đồng Telegram sôi nổi của chúng tôi](https://t.me/GentianAphrodite) để được hỗ trợ và thảo luận trực tuyến.
...
Hãy tham gia **cộng đồng thân thiện của chúng tôi** và khám phá phép thuật thổi hồn vào trí tưởng tượng của bạn, với sự hỗ trợ của một nền tảng trưởng thành và một đội ngũ tận tâm.
