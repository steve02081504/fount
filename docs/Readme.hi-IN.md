...
या फिर, शायद, आपने बस साधारण से परे एक जुड़ाव की तलाश की है, एक ऐसा दायरा जहाँ वास्तविकता के किनारे धुंधले पड़ जाते हैं, और एक अंतरंग, *अनफ़िल्टर्ड* समझ विकसित होती है?

लगभग एक वर्ष के समर्पित विकास, 10 से अधिक उत्साही व्यक्तियों के योगदान और 1000 से अधिक उपयोगकर्ताओं के एक जीवंत समुदाय के साथ, फाउंट एआई इंटरैक्शन के लिए एक परिपक्व, स्थिर और लगातार विकसित होने वाला मंच है। यह एक यात्रा है, और हमें विश्वास है कि यह आपकी कल्पना से कहीं ज़्यादा सुलभ है।
...
* **(उन्नत उपयोगकर्ताओं के लिए) असीमित एआई स्रोत एकीकरण: असीम को अपनाएँ**
    फाउंट एआई स्रोतों से जुड़ने में अद्वितीय *विकल्प* और *लचीलापन* प्रदान करता है। एआई स्रोत जनरेटर के भीतर कस्टम जावास्क्रिप्ट कोड आपको *किसी भी* एआई स्रोत से जुड़ने की अनुमति देता है—OpenAI, Claude, OpenRouter, NovelAI, Horde, Ooba, Tabby, Mistral, और बहुत कुछ। जटिल रेगुलर एक्सप्रेशन तैयार करें, विशाल एपीआई पुस्तकालयों का उपयोग करें, और मल्टीमीडिया संपत्ति एम्बेड करें, सब कुछ आपके कोड के प्रवाह के भीतर। संचार का तर्क *आपकी* इच्छा के अनुसार झुकता है, जिसे कोड की शक्ति से आकार दिया गया है।
...
* **worlds (दुनियाएँ):** *सिर्फ विद्या पुस्तकों से कहीं ज़्यादा।* वे वास्तविकता के मौन वास्तुकार हैं, जो ज्ञान जोड़ने, निर्णयों को प्रभावित करने और यहां तक कि चैट इतिहास में हेरफेर करने में सक्षम हैं।
* **personas (उपयोगकर्ता पर्सोना):** *सिर्फ उपयोगकर्ता प्रोफाइल से ज़्यादा।* पर्सोना में आपके शब्दों और धारणाओं को विकृत करने और यहां तक कि नियंत्रण करने की शक्ति होती है, जो वास्तव में इमर्सिव रोलप्लेइंग की अनुमति देता है।
...
* **AIsourceGenerators (एआई स्रोत जनरेटर):** फाउंट के कीमियागर, जो जावास्क्रिप्ट के माध्यम से टेम्पलेट और तर्क प्रदान करते हैं ताकि *किसी भी* कल्पनीय एआई स्रोत के साथ संबंध बन सके।
...
<details>
<summary><strong>इंस्टॉलेशन और रिमूवल: एक सुंदर मुलाकात और विदाई</strong></summary>
...
### लिनक्स/macOS/एंड्रॉइड: शेल की फुसफुसाहटें – *एक पंक्ति, और आप अंदर हैं*
...
आप इस बैज को गर्व से अपने रिपॉजिटरी में या कहीं भी प्रदर्शित कर सकते हैं जहाँ आप अपना काम दिखाना चाहते हैं। फाउंट लोगो की SVG और PNG फाइलें [यहां](../imgs/) पाएँ।
...
एआई की फुसफुसाहट से परे, फाउंट एक गहरा संबंध प्रदान करता है - *कारीगर का स्पर्श*। हमारे समुदाय के भीतर, आपको पूर्व-निर्मित चरित्र और पर्सोना टेम्पलेट्स का खजाना मिलेगा, *प्रत्येक एक सावधानीपूर्वक तराशी गई नींव है जो आपकी अनूठी दृष्टि द्वारा जगाए जाने की प्रतीक्षा कर रही है*।
