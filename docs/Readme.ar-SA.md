...
fount منصة تشغيل وكلاء قابلة للبرمجة ومعيارية ووحدوية وقابلة للتخصيص، تحمّل أجزاءً مختلفة لتقديم الخدمات.  
...
- اضبط الـ API ثم استخدم الشخصية الافتراضية ZL-31 لإكمال إعداد الأجزاء والإنشاء و**جميع عمليات المستخدم** عبر المحادثة—بدون تعلم أو إدماج

#### لماذا لا fount؟

- منحنى تعلم أكثر انحداراً، معرفة بالكود مطلوبة
- قد تحتوي بعض أجزاء المجتمع على كود ضار؛ احكم واختر بعناية
