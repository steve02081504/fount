...
* **تكامل مصادر الذكاء الاصطناعي بلا قيود: احتضان اللانهاية**
  يوفر fount مرونة و*اختيارًا* لا مثيل لهما في الاتصال بمصادر الذكاء الاصطناعي. تسمح لك التعليمات البرمجية المخصصة بلغة JavaScript في مولد مصادر الذكاء الاصطناعي بالاتصال *بأي* مصدر ذكاء اصطناعي - OpenAI، Claude، OpenRouter، NovelAI، Horde، Ooba، Tabby، Mistral... في تدفق التعليمات البرمجية، يمكنك تصميم تعبيرات عادية معقدة بعناية، واستدعاء مكتبات API ضخمة، وتضمين موارد الوسائط المتعددة. يدعم fount أيضًا بشكل أصلي إنشاء مجمعات API لتحقيق توجيه ذكي للطلبات. منطق الاتصال، يتبع *رغبتك*، ويتشكل بقوة التعليمات البرمجية.
